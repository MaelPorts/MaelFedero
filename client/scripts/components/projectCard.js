...
export class ProjectCard {
  ...
  static createAcademicCard(project) {
    ...
    card.innerHTML = `
            <div class="project-card-header">
                <h3 class="project-card-title">${project.title}</h3>
                <p class="project-card-subtitle">Year ${
                  project.year || "N/A"
                } • ${
      project.course || project.module || "Academic Project"
    }</p>
            </div>
            <div class="project-card-body">
                <p class="project-description">${project.description}</p>
  ...
  static createYearSection(year, projects) {
    ...
    const yearIcon = year.includes("3")
      ? "bi-award"
      : year.includes("2")
      ? "bi-book"
      : "bi-mortarboard";
  ...
  static createLinkButtons(project) {
    ...
    if (project.demo_url || project.live_url || project.live_demo_url) {
      buttons.push(`
                <a href="${
                  project.demo_url || project.live_url || project.live_demo_url
