...
export class ProjectService {
  ...
  static async getTechnicalProjects() {
    try {
      ...
      console.error(
        "Failed to fetch personal projects from API, trying static data:",
        error
      );
      ...
      try {
        ...
        console.error(
          "Failed to fetch personal projects from static data:",
          fallbackError
        );
        throw fallbackError;
      }
  ...
  static async getUniversityProjects() {
    try {
      ...
      console.error(
        "Failed to fetch university projects from API, trying static data:",
        error
      );
      // Fallback to static JSON file
      try {
        ...
        console.error(
          "Failed to fetch university projects from static data:",
          fallbackError
        );
        throw fallbackError;
      }
